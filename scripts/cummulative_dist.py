...
def main():
	data_sets = [("/users/eng/eliavb/data/youtube", False)]
	accuracy = "128"
	...
	for data_set in data_sets:
		...
		o_file = "/work/eng/eliavb/youtube" + "_" + accuracy
	...
	for i in xrange(num_nodes):
		for data_set in data_sets:
			...
			directed = "--directed="
			graph_dir = graph_dir_base + data_set[0]
			output_file_dijkstra = "--output_file=/work/eng/eliavb/experiments/youtube/" + str(random_node) + "_d"
			output_file_reverse_rank = "--output_file=/work/eng/eliavb/experiments/youtube/" + str(random_node) + "_r"
			if (data_set[1]):
				directed += "true"
			else:
				directed += "false"
