#ifndef ALL_DISTANCE_SKETCH_SRC_APP_REACH_DIFFUSION_APP_H_
#define ALL_DISTANCE_SKETCH_SRC_APP_REACH_DIFFUSION_APP_H_
...
int reach_diffusion_app_main(int ac, char* av[]) {
    int node_id;
    bool directed;
...
#endif // ALL_DISTANCE_SKETCH_SRC_APP_REACH_DIFFUSION_APP_H_