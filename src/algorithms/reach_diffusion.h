...
template <class T>
    void calculate_labels_distance_diffusion(graph::Graph<T>* graph,
                                             ...
                                             int K=0,
                                             GraphSketch* all_graph_sketch=NULL,
                                             GraphSketch* only_seed_nodes_sketch=NULL) {
      bool should_delete_graph_sketches = false;
      if (all_graph_sketch == NULL || only_seed_nodes_sketch == NULL) {
        should_delete_graph_sketches = true;
        all_graph_sketch = new GraphSketch();
        only_seed_nodes_sketch = new GraphSketch();
